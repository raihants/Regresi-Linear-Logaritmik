...
def linear_pdf(session_id: str):
    ...
    img_path = generate_chart(result["cleaned_data"], result, "linear")
    pdf_path = generate_pdf(result["cleaned_data"], result, img_path, "linear")
...
def log_pdf(session_id: str):
    ...
    img_path = generate_chart(result["cleaned_data"], result, "logarithmic")
    pdf_path = generate_pdf(result["cleaned_data"], result, img_path, "logarithmic")
