    ...
    return(
        <div className="w-[90%] md:w-3/4 mx-auto flex flex-col gap-8 mb-12">
            ...
            <div className="flex gap-4 flex-wrap">
                <div className="bg-white rounded-3xl p-8 flex flex-col gap-4 w-1/3 shadow-xl grow md:basis-0 basis-2xl">
                ...
                <div className="flex gap-4 flex-wrap md:flex-nowrap">
                    ...
                    <div className="flex flex-col items-center py-6 w-1/3 gap-6 grow">
                        ...
                        <div className="flex flex-col items-center gap-2">
                            ...
                            <p className="text-[0.85rem] md:text-xl text-gray-600 text-center">
            ...
            {/* NOTE: AI Section */}
            <div className="bg-white w-full items-center text-center rounded-3xl shadow-xl p-8">
                ...
                <div className="flex">
                    <div className="flex flex-col items-start text-start gap-8 w-full md:w-1/2 p-4">
                        ...
                        <p className="text-[0.7rem] md:text-[1rem] text-gray-600">AI Kami siap membantu Anda memahami konsep regresi linear, cara menggunakan aplikasi ini, atau menjawab pertanyaan statistik lainnya.</p>
                    ...
                    <div className="hidden md:flex flex-col gap-4 p-10 bg-white shadow-[0_12px_24px] shadow-gray-300 w-1/2 rounded-xl m-16 text-start">
            ...
            {/* NOTE: Made by*/}
            <div className="flex flex-col base-bg-gradient-br w-full text-white items-center rounded-3xl shadow-xl p-8 text-center">
