    ...
    return (
        <div className="w-3/4 mx-auto mb-12">
            <div className="bg-white border-2 border-t-8 border-primary-dark rounded-3xl p-8">
                <p className="text-2xl font-bold">Grafik Scatter Plot dengan Garis Regresi</p>

                <div className="flex flex-col gap-4 items-center text-center my-24">
                    <i className="bi bi-graph-up font-bold text-8xl" />
                ...
                <div className="flex justify-between w-full">
                    ...
                    <div className="flex gap-2 items-center">
                        <p>Ukuran Titik</p>
                        <input className="accent-black w-1/2" min="0" max="100" type="range"/>
                    </div>
                </div>

                <button type="button" className="bg-success p-4 rounded-xl shadow-[0_0_16px] shadow-success/50 text-white font-bold text-xl w-full mt-8"><i className="bi bi-arrow-clockwise mr-1"/>Perbarui Grafik</button>
            </div>
        </div>
    )
}
